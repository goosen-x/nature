...
const reviews = [
	{
		...
		review:
			'Я принимаю эти добавки уже 3 месяца и чувствую себя намноголучше. Рекомендую всем!'
	},
	{
		name: 'Михаил Петров',
		rating: 4,
		...
		review:
			'Эти добавки действительно помогают мне поддерживать здоровье. Я рекомендую их всем своим друзьям.'
	},
	{
		...
		review:
			'Я попробовала эти добавки и заметила улучшение в самочувствии. Теперь я не представляю свою жизнь без них.'
	}
]
